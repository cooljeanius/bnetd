/*
 * Copyright (C) 1998,1999,2000,2002  Ross Combs (rocombs@cs.nmsu.edu)
...
extern char const * packet_get_type_str(t_packet const * packet, t_packet_dir dir)
{
	...
	case packet_class_bnet:
		...
		return "CLIENT_CREATEACCTREQ3";
	    case CLIENT_UNKNOWN_53:
		return "CLIENT_UNKNOWN_53";
	    case CLIENT_UNKNOWN_54:
		return "CLIENT_UNKNOWN_54";
	    case CLIENT_MOTDREQ:
		return "CLIENT_MOTDREQ";
	    }
	    return "unknown";
	...
	case packet_class_bnet:
	    ...
	    case SERVER_CREATEACCTREPLY3:
		return "SERVER_CREATEACCTREPLY3";
	    case SERVER_UNKNOWN_53:
		return "SERVER_UNKNOWN_53";
	    case SERVER_UNKNOWN_54:
		return "SERVER_UNKNOWN_54";
	    case SERVER_MOTDREPLY:
		return "SERVER_MOTDREPLY";
	    }
	    return "unknown";
