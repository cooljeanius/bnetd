...
#define MAX_USER_NAME          16 /* including terminating NUL char */
#define MIN_USER_NAME           2
#define UNCHECKED_NAME_STR     32 /* including terminating NUL char */
                                  /* (longer than MAX_USER_NAME and CHAR_NAME_LEN so that
                                   *  proper error packets can be returned) */
#define MAX_NICK_LEN	MAX_USER_NAME + REALM_NAME_LEN /* including terminating NUL char and asterix betwen U_N_M and C_N_L */
...
#define MAX_TOPIC_LEN	      128 /* including terminating NUL char */
