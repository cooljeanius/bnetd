...
typedef enum
{
    ...
    eventlog_level_command=  2,
    eventlog_level_debug  =  4,
    eventlog_level_info   =  8,
    eventlog_level_notice = 16,
    eventlog_level_warn   = 32,
    eventlog_level_error  = 64,
    eventlog_level_fatal  =128,
    eventlog_level_always =256
} t_eventlog_level;
