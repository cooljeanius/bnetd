...
typedef struct
{
	...
	t_client_createacctreq3     client_createacctreq3;
	t_server_createacctreply3   server_createacctreply3;
/*	t_client_loginreq3          client_loginreq3;
 *	t_server_loginreply3        server_loginreply3;
 */
	t_client_unknown_53         client_unknown_53;
	t_server_unknown_53         server_unknown_53;
	t_client_unknown_54         client_unknown_54;
	t_server_unknown_54         server_unknown_54;
	t_client_motdreq            client_motdreq;
	t_server_motdreply          server_motdreply;
