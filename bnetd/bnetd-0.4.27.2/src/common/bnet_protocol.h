...
typedef struct
{
    ...
    bn_int        archtag;
    bn_int        clienttag;
    bn_int        versionid; /* 09 00 00 00 */
    bn_int        unknown2;  /* 00 00 00 00 always zero */
    bn_int        unknown3;  /* 00 00 00 00 */ /* C0 A8 00 03 */
    bn_int        bias;      /* (gmt-local)/60  (using signed math) */
...
#define CLIENT_COUNTRYINFO_109_VERSIONID_WAR3      0x000000c8
...
typedef struct
{
    ...
    /* equation (A=? B=? C=? N exp1 exp2 ... expN) */
...
{
    t_bnet_header h;
    bn_int        unknown1;   /* server protocol, 0==old, 1==new(beta) */
    bn_int        sessionkey;
    bn_int        sessionnum;
    bn_long       timestamp;
    /* versioncheck filename */
...
#define SERVER_AUTHREQ_109_UNKNOWN1_NORMAL 0x0000000
#define SERVER_AUTHREQ_109_UNKNOWN1_WAR3   0x0000001
/******************************************************/
...
#define CLIENT_AUTHREQ_109_GAMEVERSION_D2DV 0x01000900
#define CLIENT_AUTHREQ_109_GAMEVERSION_WAR3 0xc8000000
#define CLIENT_AUTHREQ_109_EXEINFO_D2DV "Game.exe 08/16/01 23:04:40 424067"
#define CLIENT_AUTHREQ_109_EXEINFO_WAR3 "War3.exe 02/07/02 23:39:04 24641"
...
/*
abc vlad
FF 52 48 00 3E 6D 49 E8   45 92 73 62 A5 D6 4A C4    .RH.>mI.E.sb..J.
D3 58 29 33 5C CF 3A 99   61 DD 6E E9 D9 60 8E EA    .X)3\.:.a.n..`..
BF 1D 0B 75 5F 6D DA FF   DB F9 A0 7B C8 D0 6C EA    ...u_m.....{..l.
B0 47 B8 3E B1 D0 2A B5   05 6E D7 47 5A D3 45 6E    .G.>..*..n.GZ.En
9A 73 27 33 61 62 63 00                              .s'3abc.

abc vlad
FF 52 48 00 FB 4A 2F BB   05 F7 15 EC C9 C0 59 50    .RH..J/.......YP
CA 86 C4 51 C5 17 C7 B2   05 E5 08 BD 8D BA D0 8D    ...Q............
B2 55 E4 C2 47 53 B4 45   E7 40 92 AF B9 99 19 CB    .U..GS.E.@......
95 D9 98 90 15 24 73 43   5F 07 E8 B4 0F B1 5F 94    .....$sC_....._.
1A B2 F3 3A 61 62 63 00                              ...:abc.

cba vlad
FF 52 48 00 82 AB B0 C0   52 94 93 D8 ED 19 74 D0    .RH.....R.....t.
21 C1 44 40 F4 89 BB 64   6F 03 ED 49 F1 A6 09 68    !.D@...do..I...h
39 65 40 D8 49 3B 0F DF   26 E6 F6 B9 37 6F 1F 88    9e@.I;..&...7o..
D6 54 73 4C 3A 8D C5 C0   1D F8 D6 3D 70 2C F0 77    .TsL:......=p,.w
C5 67 72 4E 63 62 61 00                              .grNcba.

Kain aaaaaaaa
FF 52 49 00 40 73 DF EF   32 C6 9F 84 0C C6 74 A7    .RI.@s..2.....t.
8D FC 19 FC 50 8F 48 C9   9F 11 CC C2 41 18 68 F4    ....P.H.....A.h. 
A6 1D 13 BA 47 32 5D 71   DD CD 1C 08 FD 0F 5A 43    ....G2]q......ZC 
91 41 8A 5B B9 A5 B9 3F   C9 A6 43 06 86 4C 32 6D    .A.[...?..C..L2m 
29 01 5E 15 4B 61 69 6E   00                         ).^.Kain. 

Kain aaaaaaaa
FF 52 49 00 C3 6C CF BF   FC 5A C5 E6 96 5B E7 33    .RI..l...Z...[.3 
DE 1B 8F B9 EE 85 98 C4   DD 67 45 D3 B2 A9 A1 C3    .........gE..... 
BF B2 8E 27 A1 77 63 15   77 46 42 29 E6 B6 9C 15    ...'.wc.wFB).... 
3A FC F4 C1 D9 ED 39 D1   9F 51 A2 1F EC 0E 49 02    :.....9..Q....I. 
6A D4 B9 63 4B 61 69 6E   00                         j..cKain. 

(matches 53ff below)
# 17 packet from client: type=0x52ff(unknown) length=78 class=bnet 
FF 52 4E 00 38 CD 63 33   1D 97 92 03 1A 4D ED B6    .RN.8.c3.....M.. 
40 4A BC 12 2E 65 4F 36   C6 9F 68 9B 9A C1 5F 77    @J...eO6..h..._w 
9E 77 F7 B8 49 BC 74 48   13 1D 2A CE D8 AE B7 71    .w..I.tH..*....q 
E7 28 B0 17 77 76 27 C5   10 13 BE 6D 1F FC 71 2E    .(..wv'....m..q. 
F7 D7 5C 5C 74 65 6D 70   31 33 33 37 36 00          ..\\temp13376. 
*/
#define CLIENT_CREATEACCTREQ3 0x52ff
typedef struct
{
    t_bnet_header h;
    bn_int        unknown[16]; /* random encrypted(?) stuff */
    /* account name */
} t_client_createacctreq3 PACKED_ATTR();
/******************************************************/


/******************************************************/
#define SERVER_CREATEACCTREPLY3 0x52ff
typedef struct
{
    t_bnet_header h;
    bn_int        result;
} t_server_createacctreply3 PACKED_ATTR();
#define SERVER_CREATEACCTREPLY3_RESULT_OK    0x00000000
#define SERVER_CREATEACCTREPLY3_RESULT_INUSE 0x00000004 /* Username is already taken */
/******************************************************/


/******************************************************/
/*
first seen in Warcraft III beta

Kain aaaaaaaa
FF 53 29 00 69 9A 66 C9   36 AF E2 FE C8 BF 2C B1    .S).i.f.6.....,. 
8E 84 8A A8 06 90 2C 67   19 CC 55 4D 0E 83 D5 2B    ......,g..UM...+ 
A1 82 6D 52 4B 61 69 6E   00                         ..mRKain. 

Kain aaaaaaaa
FF 53 29 00 37 89 76 51   FE 2E 96 05 D8 75 C7 B2    .S).7.vQ.....u.. 
C1 D0 3B A0 CC E9 3F 47   52 6C 25 5F 11 C0 48 D9    ..;...?GRl%_..H. 
74 23 67 71 4B 61 69 6E   00                         t#gqKain. 
*/
#define CLIENT_UNKNOWN_53 0x53ff /* login request? then what is 54ff? */
typedef struct
{
    t_bnet_header h;
    bn_int        unknown[8]; /* random encrypted(?) stuff */
    /* account name */
} t_client_unknown_53 PACKED_ATTR();
/******************************************************/
...
/*
first seen in Warcraft III beta
(matches 52ff from above)
FF 53 48 00 00 00 00 00   38 CD 63 33 1D 97 92 03    .SH.....8.c3.... 
1A 4D ED B6 40 4A BC 12   2E 65 4F 36 C6 9F 68 9B    .M..@J...eO6..h.
9A C1 5F 77 9E 77 F7 B8   70 44 14 6F 14 5A 61 45    .._w.w..pD.o.ZaE 
8F 17 28 C0 48 95 9B 05   9D 98 96 E5 46 FE 54 B2    ..(.H.......F.T. 
28 A5 A4 91 77 DE 22 5D                              (...w."] 
*/
#define SERVER_UNKNOWN_53 0x53ff
typedef struct
{
    t_bnet_header h;
    bn_int        result;
    bn_int        unknown2[16]; /* same as in account creation packet */
} t_server_unknown_53 PACKED_ATTR();
#define SERVER_UNKNOWN_53_RESULT_SUCCESS 0x00000000
#define SERVER_UNKNOWN_53_RESULT_FAILED  0x00000001
/******************************************************/
...
/*
first seen in Warcraft III beta
FF 54 18 00 46 E3 F9 38   21 B9 37 39 A1 3B DD E0    .T..F..8!.79.;..
0B DB 98 27 3A 8E C4 BF                              ...':...
*/
#define CLIENT_UNKNOWN_54 0x54ff
typedef struct
{
    t_bnet_header h;
    bn_int        unknown[5]; /* hash? */
} t_client_unknown_54;
/******************************************************/
...
/*
first seen in Warcraft III beta
FF 54 1C 00 00 00 00 00   DE 5B 09 CD 09 C0 E3 70    .T.......[.....p
B8 57 E8 CD 9A 56 9E 5F   82 D0 BA C3                .W...V._....
*/
#define SERVER_UNKNOWN_54 0x54ff
typedef struct
{
    t_bnet_header h;
    bn_int        response;
...
#define SERVER_UNKNOWN_54_REPONSE_OK      0x00000000   /* Login ok ?      */
#define SERVER_UNKNOWN_54_REPONSE_BADPASS 0x00000002   /* Login refused ? */
/******************************************************/
...
{
    t_bnet_header h;
    bn_byte       unknown1;       /* FIXME: motdtype? client pane? if 0x01=motd then what
                                   * is it for -- news? */
    bn_int        unknown2;       /* FIXME */
    bn_int        unknown3;       /* FIXME: message? */
    bn_int        unknown4;       /* FIXME: message? 0x00000000 */
    bn_int        unknown5;       /* FIXME: message? 0x00000000 */
    /* motd */
} t_server_motdreply;
/******************************************************/
...
#define CLIENT_GAMETYPE_DIABLO2_CLOSE            0x00000000 /* closed game */ 
/* FIXME: overlap with closed game, also looks like 3rd bit is a flag */
#define CLIENT_GAMETYPE_DIABLO2_OPEN_NORMAL_A    0x00000000 /* open, no min level, no restrict, normal difficulty */ 
#define CLIENT_GAMETYPE_DIABLO2_OPEN_NIGHTMARE_A 0x00000001 /* open, no min level, no restrict, nightmare difficulty */ 
#define CLIENT_GAMETYPE_DIABLO2_OPEN_HELL_A      0x00000002 /* open, no min level, no restrict, hell difficulty */ 
#define CLIENT_GAMETYPE_DIABLO2_OPEN_NORMAL_B    0x00000008 /* open, no min level, no restrict, normal difficulty */ 
#define CLIENT_GAMETYPE_DIABLO2_OPEN_NIGHTMARE_B 0x00000009 /* open, no min level, no restrict, nightmare difficulty */ 
#define CLIENT_GAMETYPE_DIABLO2_OPEN_HELL_B      0x0000000a /* open, no min level, no restrict, hell difficulty */ 
...
from War3 beta (thanks Warforge)
...
{
    t_bnet_header h;
    bn_int        status; /* really two bn_shorts? */
...
/* FIXME: the status values are not correct */
...
#define CLIENT_STARTGAME4_STATUS_OPEN3              0x00000004
#define CLIENT_STARTGAME4_STATUS_FULL1              0x00000006
