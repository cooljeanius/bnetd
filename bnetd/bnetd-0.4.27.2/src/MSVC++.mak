...
#
# FIXME:
# This file is now way out of date... to crappy a format to keep
# manually editing.  See about making a script to generate this from
# Makefile.in.
#
!IF "$(CFG)" == ""
...
!IF "$(CFG)" == "BNETD - Win32 Release" || "$(CFG)" == "BNETD - Win32 Debug"
SOURCE=..\src\bnetd\account_db_mysql.c

!IF  "$(CFG)" == "BNETD - Win32 Release"

CPP_SWITCHES=/nologo /ML /W3 /GX- /O2 /I "..\src" /D "WIN32" /D "NDEBUG" /D "_CONSOLE" /D "_MBCS" /D "HAVE_CONFIG_H" /Fo"$(INTD+
"$(INTDIR)\account_db_mysql.obj" : $(SOURCE) "$(INTDIR)"
       $(CPP) @<<
  $(CPP_SWITCHES) $(SOURCE)
<<
...
CPP_SWITCHES=/nologo /MLd /W3 /Gm /GX- /ZI /Od /I "..\src" /D "WIN32" /D "_DEBUG" /D "_CONSOLE" /D "_MBCS" /D "HAVE_CONFIG_H" /+
"$(INTDIR)\account_db_mysql.obj"       "$(INTDIR)\account_db_mysql.sbr" : $(SOURCE) "$(INTDIR)"
       $(CPP) @<<
  $(CPP_SWITCHES) $(SOURCE)
<<
...
SOURCE=..\src\bnetd\db_mysql.c

!IF  "$(CFG)" == "BNETD - Win32 Release"

CPP_SWITCHES=/nologo /ML /W3 /GX- /O2 /I "..\src" /D "WIN32" /D "NDEBUG" /D "_CONSOLE" /D "_MBCS" /D "HAVE_CONFIG_H" /Fo"$(INTD+
"$(INTDIR)\db_mysql.obj" : $(SOURCE) "$(INTDIR)"
       $(CPP) @<<
  $(CPP_SWITCHES) $(SOURCE)
<<
...
CPP_SWITCHES=/nologo /MLd /W3 /Gm /GX- /ZI /Od /I "..\src" /D "WIN32" /D "_DEBUG" /D "_CONSOLE" /D "_MBCS" /D "HAVE_CONFIG_H" /+
"$(INTDIR)\db_mysql.obj"       "$(INTDIR)\db_mysql.sbr" : $(SOURCE) "$(INTDIR)"
       $(CPP) @<<
  $(CPP_SWITCHES) $(SOURCE)
<<
...
SOURCE=..\src\bnetd\friends.c

!IF  "$(CFG)" == "BNETD - Win32 Release"


"$(INTDIR)\friends.obj" : $(SOURCE) "$(INTDIR)"
	$(CPP) $(CPP_PROJ) $(SOURCE)
...
"$(INTDIR)\friends.obj"	"$(INTDIR)\friends.sbr" : $(SOURCE) "$(INTDIR)"
	$(CPP) $(CPP_PROJ) $(SOURCE)
