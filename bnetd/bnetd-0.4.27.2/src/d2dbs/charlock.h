...
int cl_destroy(void);
int cl_query_charlock_status(char *charname,
		char *realmnamei, unsigned int *gsid);
int cl_lock_char(char *charname,
	        char *realmname, unsigned int gsid);
int cl_unlock_char(char *charname, char *realmname);
