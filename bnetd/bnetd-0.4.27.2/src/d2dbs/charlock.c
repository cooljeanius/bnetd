...
extern int cl_init(unsigned int tbllen, unsigned int maxgs)
{
...
extern int cl_query_charlock_status(char * charname, char * realmname, unsigned int * gsid)
{
	t_charlockinfo	*pcl;
...
extern int cl_lock_char(char *charname, char *realmname, unsigned int gsid)
{
	...
	/* FIXME: doesn't that need nul termination? */
...
extern int cl_unlock_char(char *charname, char *realmname)
{
	t_charlockinfo	*pcl, *ptmp;
	unsigned int	hashval;
...
extern int cl_unlock_all_char_by_gsid(unsigned int gsid)
{
