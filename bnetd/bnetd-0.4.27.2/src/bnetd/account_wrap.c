...
extern char const * account_get_watch(t_account * account)
{
    char const * temp;

    if (!account)
    {
	eventlog(eventlog_level_error,"account_get_watch","got NULL account");
	return NULL;
    }
    if (!(temp = account_get_strattr(account,"BNET\\acct\\watch")))
	return "";
    return temp;
}


extern int account_unget_watch(char const * watch)
{
    return account_unget_strattr(watch);
}


extern char const * account_get_ignore(t_account * account)
{
    char const * temp;

    if (!account)
    {
	eventlog(eventlog_level_error,"account_get_ignore","got NULL account");
	return NULL;
    }
    if (!(temp = account_get_strattr(account,"BNET\\acct\\ignore")))
	return "";
    return temp;
}


extern int account_unget_ignore(char const * ignore)
{
    return account_unget_strattr(ignore);
}
...
extern int account_unget_friends(char const * friends)
{
    return account_unget_strattr(friends);
}
...
/* KWS */
extern char const * account_get_fl_ip(t_account * account)
{
     return account_get_strattr(account,"BNET\\acct\\firstlogin_ip");
}


extern int account_unget_fl_ip(char const * ip)
{
    return account_unget_strattr(ip);
}


extern int account_set_fl_ip(t_account * account, char const * ip)
{
    return account_set_strattr(account,"BNET\\acct\\firstlogin_ip",ip);
}
