...
/* JEBs20021022: To share code between both daemons (d2cs/d2bs/d2gs).
        i.e. in "d2cs/d2cs_d2gs_character.h" */
/* JEBs20021025: I know this is tricky but i check the define of
   		"D2CS" now too in common/db_mysql.c */
#ifndef D2CS
# define D2CS
#endif
